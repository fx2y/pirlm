...
def main():
    ...
    for plan_str in plans:
        ...
        cmd = [
            sys.executable, "-m", "pirml.web.eval.browsecomp_shard",
    ...
    winner = max(all_results, key=lambda r: metric_tuple({
        "qid": "", "plan": "", 
        "acc": r["acc"], 
