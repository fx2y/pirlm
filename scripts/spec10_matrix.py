...
def get_matrix_rows() -> list[dict[str, Any]]:
    ...
    return [
        ...
        # W0
        {
            ...
            "cmd": "mise run fast && mise run ci && python -m scripts.pirml_run --prog tests/prog_ok.py --out-dir out/demo --project-root .",
            "authority": True,
            "deps": [],
            "deterministic": True,
            "optional": False,
        ...
        # W2
        {
            ...
            "cmd": "python -m scripts.pirml_run --tool init acme.lookup --tools-dir out/w2/tools",
            "authority": True,
            "deps": [],
            "deterministic": True,
            "optional": False,
        ...
        # W3
        {
            ...
            "cmd": "python -m scripts.compile tests/prog_ok.py --out-dir out/w3/compile",
            "authority": True,
            "deps": [],
            "deterministic": True,
            "optional": False,
