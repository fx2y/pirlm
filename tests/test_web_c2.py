...
from pirml.web.etl.core import fallback_extract, kill_boilerplate, select_top_chunks
...
class WebC2Tests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_html_extraction(self):
        ...
        chunks = extract_html_chunks(
            html, url="u1", doc_sha256="s1", source_rank=1, doc_rank=1
        )
    ...
    def test_boilerplate_kill(self):
        ...
        chunks = [
            {"text": "This is some repeated boilerplate that should be killed.", "kind": "p", "doc_sha256": "s1", "url": "u1", "chunk_id": "c1", "score": 0.0, "source_rank": 1, "doc_rank": 1},
            {"text": "This is some unique content that should definitely be kept because it is long enough.", "kind": "p", "doc_sha256": "s2", "url": "u2", "chunk_id": "c2", "score": 0.0, "source_rank": 2, "doc_rank": 2},
        ]
        import hashlib
        import re
    ...
    def test_scorers(self):
        chunk = {"text": "Python is a programming language created in 1991.", "kind": "p", "doc_sha256": "s1", "url": "u1", "chunk_id": "c1", "score": 0.0, "source_rank": 1, "doc_rank": 1}
        ...
        chunks = [
            chunk,
            {"text": "Cooking pasta is easy.", "kind": "p", "doc_sha256": "s2", "url": "u2", "chunk_id": "c2", "score": 0.0, "source_rank": 2, "doc_rank": 2},
        ]
    ...
    def test_join_dedup(self):
        chunks = [
            {"text": "Same text", "kind": "p", "doc_sha256": "s1", "url": "u1", "chunk_id": "c1", "score": 1.0, "source_rank": 1, "doc_rank": 1},
            {"text": "same text ", "kind": "p", "doc_sha256": "s2", "url": "u2", "chunk_id": "c2", "score": 0.5, "source_rank": 2, "doc_rank": 2},
        ]
    ...
    def test_citation_packing(self):
        chunks = [
            {"text": "PIRML is deterministic.", "kind": "p", "doc_sha256": "s1", "url": "u1", "chunk_id": "ck0001", "score": 1.0, "source_rank": 1, "doc_rank": 1},
        ]
    ...
    async def test_full_pipeline(self):
        ...
        provider = MockProvider({
            "what is pirml?": [
                {"url": "https://example.com/p", "title": "PIRML", "snippet": "...", "rank": 1, "source": "test"}
            ]
        })
        
        # Fixture fetcher
        fetcher = FixtureDocFetcher(Path("tests/fixtures/web/responses.json"))
        fetcher._records["https://example.com/p"] = fetcher._records["https://example.com/docs/page?a=1&b=2"]
        ...
        if not golden_path.exists() and os.getenv("PIRML_UPDATE_GOLDEN") == "1":
